...
(async () => {
  ...
  await fs.writeFile("ccu013_01-covid-19-infection-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("ccu013_01-covid-19-infection-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
